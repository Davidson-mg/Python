...
class Comentario(models.Model):
    ...
    usuario_comentario = models.ForeignKey(User, on_delete=models.DO_NOTHING)#Digamos que um funcionario que postava
    #artigos no blog tenha sido demitido, não queremos que os artigos dele sejam apagados. Por isso usamos
